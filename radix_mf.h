...
typedef struct UF2_matchTable_s UF2_matchTable;
...
UF2_matchTable* RMF_createMatchTable(const RMF_parameters* const params, size_t const dict_reduce, unsigned const thread_count);
void RMF_freeMatchTable(UF2_matchTable* const tbl);
BYTE RMF_compatibleParameters(const UF2_matchTable* const tbl, const RMF_parameters* const params, size_t const dict_reduce);
size_t RMF_applyParameters(UF2_matchTable* const tbl, const RMF_parameters* const params, size_t const dict_reduce);
